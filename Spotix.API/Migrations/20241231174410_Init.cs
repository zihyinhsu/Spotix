        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgUrl = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatSelection = table.Column<bool>(type: "bit", nullable: false),
                    Number = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    IsSold = table.Column<bool>(type: "bit", nullable: false),
                    IsTransfered = table.Column<bool>(type: "bit", nullable: false),
                    Reciever = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {

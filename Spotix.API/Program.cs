...
builder.Services.AddScoped<IEventRepository, EventRepository>();// 註冊 EventRepository
builder.Services.AddScoped<IAreaRepository, AreaRepository>();// 註冊 AreaRepository
builder.Services.AddScoped<ITicketRepository, TicketRepository>();// 註冊 ITicketRepository
builder.Services.AddScoped<AreaService>();// 註冊 AreaService
